 ...
 * @author helanio
 */
public class TicketEditAction extends org.apache.struts.action.Action {
   ...
   // extract user data
        ...
        int idTicket = formBean.getIdTicket();
        
        //Valitation
        
        if (idTicket == 0){
            formBean.setError("<span style='color:red'> Can't retrive idTicket.</span>");
        ...
        //updateTicket
        boolean sucess = dao.updateTicket(idTicket, system, component, description, title);
        if(sucess){
